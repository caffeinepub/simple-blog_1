...
import { useGetMyDrafts, useDeleteDraft, useUpdatePost } from '../hooks/useQueries';
...
import { Loader2, FileText, PenSquare, Trash2, Globe, ArrowLeft, BookOpen } from 'lucide-react';
...
function DraftCard({ draft, onEdit, onPublish, onDelete, isPublishing, isDeleting }: {
  draft: Post;
  onEdit: () => void;
  onPublish: () => void;
  onDelete: () => void;
    ...
    <Card className="border-border/40 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            <CardTitle className="text-lg font-serif font-semibold leading-snug line-clamp-2">
              {draft.title || <span className="text-muted-foreground italic">(Utan titel)</span>}
            </CardTitle>
      ...
      <CardContent className="pt-0">
        {preview ? (
          ...
          <p className="text-sm text-muted-foreground italic mb-4">Inget innehåll ännu.</p>
        )}
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Är du säker på att du vill ta bort detta utkast permanent? Åtgärden kan inte ångras.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
...
export default function MyDraftsPage() {
  ...
  return (
    <div className="container max-w-4xl mx-auto px-6 py-16">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-serif font-bold tracking-tight">Mina utkast</h1>
      ...
      {isError && (
        <div className="text-center py-16">
          <p className="text-destructive mb-4">Kunde inte hämta utkast. Försök igen.</p>
      ...
      {!isLoading && !isError && drafts && drafts.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h2 className="text-xl font-serif font-semibold mb-2">Inga utkast ännu</h2>
          <p className="text-muted-foreground mb-6 max-w-sm">
            Du har inga sparade utkast. Börja skriva ett nytt inlägg och spara det som utkast.
          </p>
